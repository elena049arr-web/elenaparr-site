...
/* ---------- Hero tagline: word-by-word pop-in reveal ----------
   ...
   own span), then reveals them in a staggered cascade — inspired by the
   word-pop intro on spencergabor.work. The linked "Stellina Mae" text
   is kept intact as its own single reveal unit rather than split further,
   so the link stays clickable and doesn't fragment mid-phrase. */
(function setupHeroTaglineReveal() {
